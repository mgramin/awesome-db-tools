...
- [yuniql](https://github.com/rdagumampan/yuniql) - Schema versioning and migration tool made with .NET Core 3.0+. Stand-alone .exe file (No CLR needed!), plain SQL files supported by ready to use Azure DevOps tasks. https://yuniql.io
