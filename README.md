...
- [GlareDB](https://github.com/GlareDB/glaredb/) - SQL engine with many data sources (CSV, PostgreSQL, MongoDB, Excel, Parquet, BigQuery, Snowflake, SQL Server, etc.) that scales from embedded to large cloud workloads.
